...
export default function ProviderRegistrationPage() {
    ...
    return (_jsxs("div", { style: {
            ...
            boxSizing: 'border-box' // important to avoid overflow
                    ...
                    minWidth: '300px'
                }, children: [_jsx("input", { type: "text", placeholder: "Enter your ID", value: id, onChange: (e) => setId(e.target.value), style: {
                            padding: '0.75rem',
                            fontSize: '1rem',
                            ...
                            border: '1px solid #ccc',
                            borderRadius: '8px'
                        }, children: [_jsx("option", { value: "reveal_both", children: "Reveal Both" }), _jsx("option", { value: "hide_id", children: "Hide ID" }), _jsx("option", { value: "hide_ser", children: "Hide Service" }), _jsx("option", { value: "hide_both", children: "Hide Both" })] }), _jsx("button", { type: "submit", style: {
                            padding: '0.75rem',
                            fontSize: '1rem',
                            ...
                            borderRadius: '8px',
                            cursor: 'pointer'
                        }, children: "Register" }), message && _jsx("div", { style: { color: '#d32f2f', marginTop: '1rem' }, children: message })] })] }));
}
